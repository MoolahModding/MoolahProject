...
UAkComponent* UAkGameplayStatics::SpawnAkComponentAtLocation(UObject* WorldContextObject, UAkAudioEvent* AkEvent, FVector Location, FRotator Orientation, bool AutoPost, const FString& EventName, ESBZAkPoolType Type, bool AutoDestroy) {
    return NULL;
}
...
int32 UAkGameplayStatics::RemoveOutput(const FAkOutputDeviceID& ID) {
    return 0;
}
...
int32 UAkGameplayStatics::AddOutput(const FAkOutputSettings& in_Settings) {
    return 0;
}
