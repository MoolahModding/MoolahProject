...
void UAccelByteBlueprintsCategory::GetDescendantCategories(const FString& Language, const FString& CategoryPath, const UAccelByteBlueprintsCategory::FGetDescendantCategoriesSuccess& OnSuccess, const UAccelByteBlueprintsCategory::FBlueprintErrorHandler& OnError) {
}

void UAccelByteBlueprintsCategory::GetChildCategories(const FString& Language, const FString& CategoryPath, const UAccelByteBlueprintsCategory::FGetChildCategoriesSuccess& OnSuccess, const UAccelByteBlueprintsCategory::FBlueprintErrorHandler& OnError) {
}
