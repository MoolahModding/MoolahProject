...
void UAccelByteBlueprintsServerSettings::SetSessionServerUrl(const FString& SessionServerUrl) {
}
...
void UAccelByteBlueprintsServerSettings::SetQosManagerServerUrl(const FString& PlatformServerUrl) {
}
...
void UAccelByteBlueprintsServerSettings::SetCloudSaveServerUrl(const FString& CloudServerUrl) {
}
