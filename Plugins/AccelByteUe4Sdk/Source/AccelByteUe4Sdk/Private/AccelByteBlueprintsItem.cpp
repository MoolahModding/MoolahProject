...
void UAccelByteBlueprintsItem::GetItemsByCriteria(const FAccelByteModelsItemCriteria& ItemCriteria, const int32& Offset, const int32& Limit, TArray<EAccelByteItemListSortBy> SortBy, const UAccelByteBlueprintsItem::FGetItemsByCriteriaSuccess& OnSuccess, const UAccelByteBlueprintsItem::FBlueprintErrorHandler& OnError) {
}

void UAccelByteBlueprintsItem::GetItemById(const FString& ItemId, const FString& Region, const FString& Language, const UAccelByteBlueprintsItem::FGetItemByIdSuccess& OnSuccess, const UAccelByteBlueprintsItem::FBlueprintErrorHandler& OnError) {
}
