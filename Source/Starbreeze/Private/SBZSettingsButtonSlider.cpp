...
void USBZSettingsButtonSlider::SetMinValue(float NewMinSliderValue) {
}

void USBZSettingsButtonSlider::SetMaxValue(float NewMaxSliderValue) {
}

void USBZSettingsButtonSlider::SetIncrementValue(float NewIncrementValue) {
}
