...
UParticleSystemComponent* USBZParticleLibrary::InternalSpawnPooledEmitterAtLocation(const UWorld* World, UParticleSystem* EmitterTemplate, FVector SpawnLocation, FRotator SpawnRotation, FVector SpawnScale) {
    return NULL;
}
