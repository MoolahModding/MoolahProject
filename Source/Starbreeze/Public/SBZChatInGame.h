...
protected:
    ...
    void ServerChatMessageReceived(int32 PlayerId, const FSBZPlayerChatEvent& ChatEventData);
...
public:
    ...
    void MulticastChatMessageReceived(int32 PlayerId, const FSBZPlayerChatEvent& ChatEventData);
